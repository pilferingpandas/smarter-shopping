...
var FeedItem = Eventful.createClass({
  getInitialState: function() {
    return (
      value: this.props.name,
      editable: false
      // TODO: add an addable category so that users scrolling through items in feed can easily add them
    );
  },
  componentWillReceiveProps: function(newProps) {
    this.setState({ value: newProps.name });
  },
  // switchToAddable: function() {
  //   this.setState({addable: true}, function() {
  //     React.findDOMNode(this.refs.addInput).focus();
  //   });
  // },
  // removeItem: function() {
